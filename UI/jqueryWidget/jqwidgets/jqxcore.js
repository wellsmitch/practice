...
if (!oldBrowser) {
    (function(bd, G) {
            var q, an, ak = bd.document, bo = bd.location, bt = bd.navigator, ax = bd.JQXLite, X = bd.$, aR = Array.prototype.push, aD = Array.prototype.slice, aA = Array.prototype.indexOf, y = Object.prototype.toString, b = Object.prototype.hasOwnProperty, aw = String.prototype.trim, C = function(bu, bv) {
                return new C.fn.init(bu,bv,q)
            }, aE = /[\-+]?(?:\d*\.|)\d+(?:[eE][\-+]?\d+|)/.source, at = /\S/, a8 = /\s+/, S = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, aF = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, e = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, j = /^[\],:{}\s]*$/, t = /(?:^|:|,)(?:\s*\[)+/g, a5 = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, K = /"[^"\\\r\n]*"|true|false|null|-?(?:\d\d*\.|)\d+(?:[eE][\-+]?\d+|)/g, au = /^-ms-/, aS = /-([\da-z])/gi, m = function(bu, bv) {
            ...
            C.extend = C.fn.extend = function() {
                var bD, bw, bu, bv, bA, bB, bz = arguments[0] || {}, by = 1, bx = arguments.length, bC = false;
            ...
            C.extend({
                ...
                each: function(bz, bA, bw) {
                    var bv, bx = 0, by = bz.length, bu = by === G || C.isFunction(bz);
                    if (bw) {
                        if (bu) {
                            for (bv in bz) {
                ...
                map: function(bu, bB, bC) {
                    var bz, bA, by = [], bw = 0, bv = bu.length, bx = bu instanceof C || bv !== G && typeof bv === "number" && ((bv > 0 && bu[0] && bu[bv - 1]) || bv === 0 || C.isArray(bu));
                    if (bx) {
                        for (; bw < bv; bw++) {
                            bz = bB(bu[bw], bw, bC);
                            if (bz != null) {
                ...
                access: function(bu, bA, bD, bB, by, bE, bC) {
                    var bw, bz = bD == null, bx = 0, bv = bu.length;
            ...
            C.Callbacks = function(bE) {
                ...
                var bx, bu, by, bw, bz, bA, bB = [], bC = !bE.once && [], bv = function(bF) {
                    bx = bE.memory && bF;
                    bu = true;
                    bA = bw || 0;
                    bw = 0;
            ...
            C.extend({
                ...
                when: function(by) {
                    var bw = 0, bA = aD.call(arguments), bu = bA.length, bv = bu !== 1 || (by && C.isFunction(by.promise)) ? bu : 0, bD = bv === 1 ? by : C.Deferred(), bx = function(bF, bG, bE) {
                        return function(bH) {
                            bG[bF] = this;
            ...
            C.support = (function() {
                    ...
                    C(function() {
                        var bI, bM, bK, bL, bJ = "padding:0;margin:0;border:0;display:block;overflow:hidden;", bH = ak.getElementsByTagName("body")[0];
                        if (!bH) {
                            return
                        }
            ...
            C.extend({
                ...
                data: function(bx, bv, bz, by) {
                    ...
                    var bA, bC, bD = C.expando, bB = typeof bv === "string", bE = bx.nodeType, bu = bE ? C.cache : bx, bw = bE ? bx[bD] : bx[bD] && bD;
                ...
                removeData: function(bx, bv, by) {
                    ...
                    var bB, bA, bz, bC = bx.nodeType, bu = bC ? C.cache : bx, bw = bC ? bx[C.expando] : C.expando;
                    if (!bu[bw]) {
                        return
                    }
                    if (bv) {
            ...
            C.fn.extend({
                data: function(bD, bC) {
                    var by, bv, bB, bu, bx, bw = this[0], bA = 0, bz = null;
                    if (bD === G) {
                        if (this.length) {
                            bz = C.data(bw);
            ...
            C.fn.extend({
                ...
                promise: function(bw, bA) {
                    var bv, bx = 1, bB = C.Deferred(), bz = this, bu = this.length, by = function() {
                        if (!(--bx)) {
            ...
            var bh, aT, ay, aI = /[\t\r\n]/g, aP = /\r/g, d = /^(?:button|input)$/i, z = /^(?:button|input|object|select|textarea)$/i, h = /^a(?:rea|)$/i, ae = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, A = C.support.getSetAttribute;
            C.fn.extend({
                attr: function(bu, bv) {
                ...
                toggleClass: function(bx, bv) {
                    ...
                    return this.each(function() {
                        if (bw === "string") {
                            var bA, bz = 0, by = C(this), bB = bv, bC = bx.split(a8);
                            while ((bA = bC[bz++])) {
            ...
            C.extend({
                valHooks: {
                    ...
                    select: {
                        get: function(bu) {
                            var bA, bw, bC = bu.options, by = bu.selectedIndex, bx = bu.type === "select-one" || by < 0, bB = bx ? null : [], bz = bx ? by + 1 : bC.length, bv = by < 0 ? bz : bx ? by : 0;
                            for (; bv < bz; bv++) {
                                bw = bC[bv];
            ...
            C.event = {
                ...
                trigger: function(bv, bC, bA, bJ) {
                    ...
                    var bu, bx, bD, bH, bz, by, bF, bE, bB, bI, bG = bv.type || bv, bw = [];
                ...
                dispatch: function(bu) {
                    ...
                    var bB, bA, bK, bE, bD, bv, bC, bI, bx, bJ, by = ((C._data(this, "events") || {})[bu.type] || []), bz = by.delegateCount, bG = aD.call(arguments), bw = !bu.exclusive && !bu.namespace, bF = C.event.special[bu.type] || {}, bH = [];
                    bG[0] = bu;
                ...
                mouseHooks: {
                    ...
                    filter: function(bx, bw) {
                        var by, bz, bu, bv = bw.button, bA = bw.fromElement;
                ...
                fix: function(bw) {
                    ...
                    var bv, bz, bu = bw, bx = C.event.fixHooks[bw.type] || {}, by = bx.props ? this.props.concat(bx.props) : this.props;
                    bw = C.Event(bu);
                    for (bv = by.length; bv; ) {
                        bz = by[--bv];
                        bw[bz] = bu[bz]
            ...
            C.each({
                ...
                C.event.special[bv] = {
                    ...
                    bindType: bu,
                    handle: function(bz) {
                        var bx, bB = this, bA = bz.relatedTarget, by = bz.handleObj, bw = by.selector;
         ...
         */
            (function(cn, bM) {
                    var cs, bF, cg, bv, bR, b5, bI, bL, bH, ce, bE = true, bZ = "undefined", cu = ("sizcache" + Math.random()).replace(".", ""), bz = String, bD = cn.document, bG = bD.documentElement, bW = 0, bK = 0, b9 = [].pop, cr = [].push, bQ = [].slice, bT = [].indexOf || function(cE) {
                        var cD = 0
                            , cC = this.length;
                        for (; cD < cC; cD++) {
                            if (this[cD] === cE) {
                    ...
                    function ca(cC) {
                        return cw(function(cD) {
                            ...
                            return cw(function(cE, cI) {
                                var cG, cF = cC([], cE.length, cD), cH = cF.length;
                                while (cH--) {
                                    if (cE[(cG = cF[cH])]) {
                                        cE[cG] = !(cI[cG] = cE[cG])
                                    }
                            ...
                            PSEUDO: function(cF, cE) {
                                ...
                                if (cD.length > 1) {
                                    ...
                                    return cg.setFilters.hasOwnProperty(cF.toLowerCase()) ? cw(function(cI, cK) {
                                        var cH, cG = cD(cI, cE), cJ = cG.length;
                                        while (cJ--) {
                                            cH = bT.call(cI, cG[cJ]);
                                            cI[cH] = !(cK[cH] = cG[cJ])
                                        }
                        ...
                        pseudos: {
                            not: cw(function(cC) {
                                ...
                                return cF[cu] ? cw(function(cH, cM, cK, cI) {
                                    var cL, cG = cF(cH, null, cI, []), cJ = cH.length;
                                    while (cJ--) {
                                        if ((cL = cG[cJ])) {
                                            cH[cJ] = !(cM[cJ] = cL)
                                        }
                    ...
                    bL = bG.compareDocumentPosition ? function(cD, cC) {
                        ...
                        : function(cK, cJ) {
                            ...
                            var cH, cD, cE = [], cC = [], cG = cK.parentNode, cI = cJ.parentNode, cL = cG;
                            if (cG === cI) {
                                return bx(cK, cJ)
                            } else {
                                if (!cG) {
                    ...
                    function b0(cC, cD, cE, cF, cI) {
                        var cG, cL = [], cH = 0, cJ = cC.length, cK = cD != null;
                        for (; cH < cJ; cH++) {
                            if ((cG = cC[cH])) {
                                if (!cE || cE(cG, cF, cI)) {
                                    cL.push(cG);
                    ...
                    function cx(cE, cD, cG, cF, cH, cC) {
                        ...
                        return cw(function(cS, cP, cK, cR) {
                            var cU, cQ, cM, cL = [], cT = [], cJ = cP.length, cI = cS || bU(cD || "*", cK.nodeType ? [cK] : cK, []), cN = cE && (cS || !cD) ? b0(cI, cL, cE, cK, cR) : cI, cO = cG ? cH || (cS ? cE : cJ || cF) ? [] : cP : cN;
                            if (cG) {
                                cG(cN, cO, cK, cR)
                            }
                            if (cF) {
                    ...
                    function b2(cI) {
                        var cD, cG, cE, cH = cI.length, cL = cg.relative[cI[0].type], cM = cL || cg.relative[" "], cF = cL ? 1 : 0, cJ = b1(function(cN) {
                            return cN === cD
                        }, cM, true), cK = b1(function(cN) {
                            return bT.call(cD, cN) > -1
                        }, cM, true), cC = [function(cP, cO, cN) {
                    ...
                    function bB(cF, cE) {
                        var cC = cE.length > 0
                            ...
                            var cL, cM, cR, cV = [], cU = 0, cN = "0", cH = cQ && [], cS = cW != null, cT = ce, cJ = cQ || cG && cg.find.TAG("*", cW && cK.parentNode || cK), cI = (bW += cT == null ? 1 : Math.E);
                            if (cS) {
                                ce = cK !== bD && cK;
                                cs = cD.el
                            }
                    ...
                    function ct(cE, cC, cG, cK, cJ) {
                        var cH, cN, cD, cM, cL, cI = bw(cE), cF = cI.length;
                        if (!cK) {
                            if (cI.length === 1) {
                    ...
                    if (bD.querySelectorAll) {
                        (function() {
                                var cH, cI = ct, cG = /'|\\/g, cE = /\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g, cD = [":focus"], cC = [":active"], cF = bG.matchesSelector || bG.mozMatchesSelector || bG.webkitMatchesSelector || bG.oMatchesSelector || bG.msMatchesSelector;
                                cf(function(cJ) {
                                ...
                                ct = function(cP, cK, cR, cU, cT) {
                                    if (!cU && !cT && !cD.test(cP)) {
                                        var cN, cS, cM = true, cJ = cu, cL = cK, cQ = cK.nodeType === 9 && cP;
            ...
            C.fn.extend({
                ...
                has: function(bx) {
                    var bw, bv = C(bx, this), bu = bv.length;
                ...
                closest: function(by, bx) {
                    var bz, bw = 0, bu = this.length, bv = [], bA = aQ.test(by) || typeof by !== "string" ? C(by, bx || this.context) : 0;
                    for (; bw < bu; bw++) {
                        bz = this[bw];
            ...
            function aB(bv, bu) {
                do {
                    bv = bv[bu]
                } while (bv && bv.nodeType !== 1);return bv
            }
            C.each({
                parent: function(bv) {
            ...
            C.fn.extend({
                ...
                domManip: function(bA, bE, bD) {
                    bA = [].concat.apply([], bA);
                    var bw, by, bz, bC, bx = 0, bB = bA[0], bv = [], bu = this.length;
            ...
            function r(bB, bv) {
                ...
                var by, bx, bu, bA = C._data(bB), bz = C._data(bv, bA), bw = bA.events;
                if (bw) {
                    delete bz.handle;
                    bz.events = {};
                    for (by in bw) {
                        for (bx = 0,
                                 bu = bw[by].length; bx < bu; bx++) {
            ...
            C.each({
                ...
                C.fn[bu] = function(bw) {
                    var by, bA = 0, bz = [], bC = C(bw), bx = bC.length, bB = this.length === 1 && this[0].parentNode;
            ...
            C.extend({
                ...
                clean: function(bH, bw, bu, bx) {
                    var bE, bD, bG, bL, bA, bK, bB, by, bv, bF, bJ, bC, bz = bw === ak && T, bI = [];
                ...
                cleanData: function(bv, bD) {
                    var by, bw, bx, bC, bz = 0, bE = C.expando, bu = C.cache, bA = C.support.deleteExpando, bB = C.event.special;
            ...
            var Q, bc, l, ad = /alpha\([^)]*\)/i, aj = /opacity=([^)]*)/, w = /^(top|right|bottom|left)$/, ai = /^(none|table(?!-c[ea]).+)/, av = /^margin/, i = new RegExp("^(" + aE + ")(.*)$","i"), aV = new RegExp("^(" + aE + ")(?!px)[a-z%]+$","i"), E = new RegExp("^([-+])=(" + aE + ")","i"), J = {
                BODY: "block"
            }, ba = {
                position: "absolute",
                visibility: "hidden",
                ...
                letterSpacing: 0,
                fontWeight: 400
            }, D = ["Top", "Right", "Bottom", "Left"], O = ["Webkit", "O", "Moz", "ms"], be = C.fn.toggle;
            function a2(bx, bv) {
                if (bv in bx) {
                    return bv
                }
            ...
            function bb(bz, bu) {
                var by, bA, bv = [], bw = 0, bx = bz.length;
                for (; bw < bx; bw++) {
                    by = bz[bw];
                    if (!by.style) {
                        continue
            ...
            C.extend({
                ...
                style: function(bw, bv, bC, bx) {
                    ...
                    var bA, bB, bD, by = C.camelCase(bv), bu = bw.style;
            ...
            if (bd.getComputedStyle) {
                Q = function(bB, bv) {
                    var bu, by, bx, bA, bz = bd.getComputedStyle(bB, null), bw = bB.style;
                    if (bz) {
                ...
                if (ak.documentElement.currentStyle) {
                    Q = function(by, bw) {
                        var bz, bu, bv = by.currentStyle && by.currentStyle[bw], bx = by.style;
                        if (bv == null && bx && bx[bw]) {
                            bv = bx[bw]
                        }
            ...
            var a6, a1, ar = /^(?:toggle|show|hide)$/, aM = new RegExp("^(?:([-+])=|)(" + aE + ")([a-z%]*)$","i"), a7 = /queueHooks$/, k = [bm], H = {
                "*": [function(bu, bB) {
                    var bx, bC, bD = this.createTween(bu, bB), by = aM.exec(bB), bz = bD.cur(), bv = +bz || 0, bw = 1, bA = 20;
                    if (by) {
                        bx = +by[2];
            ...
            function bj(bw, bA, bD) {
                var bE, bz = 0, bu = 0, bv = k.length, bC = C.Deferred().always(function() {
                    delete by.elem
                }), by = function() {
                    var bK = a6 || bl()
            ...
            function bm(by, bE, bu) {
                var bD, bw, bG, bx, bK, bA, bJ, bI, bH, bz = this, bv = by.style, bF = {}, bC = [], bB = by.nodeType && ap(by);
                if (!bu.queue) {
            ...
            C.fn.offset = function(bE) {
                ...
                var bv, bA, bB, by, bC, bu, bx, bz = {
                    top: 0,
                    left: 0
                }, bw = this[0], bD = bw && bw.ownerDocument;
                if (!bD) {
                    return
                }
                if ((bA = bD.body) === bw) {
            ...
            C.offset = {
                ...
                setOffset: function(bx, bG, bA) {
                    ...
                    var bz = C(bx), bv = bz.offset(), bu = C.css(bx, "top"), bE = C.css(bx, "left"), bF = (bB === "absolute" || bB === "fixed") && C.inArray("auto", [bu, bE]) > -1, bD = {}, bC = {}, bw, by;
                    if (bF) {
                        bC = bz.position();
                        bw = bC.top;
                        by = bC.left
                    ...
                    switch (e) {
                        case "mousewheel":
                            if (b.jqx.browser.mozilla) {
                                h[0].addEventListener("DOMMouseScroll", f, false)
                            } else {
                                h[0].addEventListener("mousewheel", f, false)
                            }
                            continue;
                        case "mousemove":
                            if (!g) {
